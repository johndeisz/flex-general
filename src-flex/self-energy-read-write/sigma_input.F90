...
#include "../constants.F90"
      ...
      if (rank .eq. 0) then
        ...
        read(50,*) ! nb
        read(50,*)
        read(50,*) lcx_in, lcy_in, lcz_in, id1, llx_in, lly_in,
     $     llz_in
        read(50,*)  ! string
...
#ifdef USE_MPI
        call MPI_Bcast(uu_1, 1, MPI_REAL, 0,
     $     MPI_COMM_WORLD, ierr)
        call MPI_Bcast(lcx_in, 1, MPI_INTEGER, 0,
     $     MPI_COMM_WORLD, ierr)
        call MPI_Bcast(lcy_in, 1, MPI_INTEGER, 0,
     $     MPI_COMM_WORLD, ierr)
        call MPI_Bcast(lcz_in, 1, MPI_INTEGER, 0,
     $     MPI_COMM_WORLD, ierr)
        call MPI_Bcast(llx_in, 1, MPI_INTEGER, 0,
     $     MPI_COMM_WORLD, ierr)
        call MPI_Bcast(lly_in, 1, MPI_INTEGER, 0,
     $     MPI_COMM_WORLD, ierr)
        call MPI_Bcast(llz_in, 1, MPI_INTEGER, 0,
     $     MPI_COMM_WORLD, ierr)
#endif /* USE_MPI */


c     Determine how to stretch/compress the input pair wave function
c     if the lattice size for the input file
c     and the present calculation do not match.
...
c     Stretch the pair wave function.
...
c Read and scale the Hartree self-energy
        do nu1 = 0, nb-1
          do ia1 = 0, 3
            do nu2 = 0, nb-1
              do ia2 = 0, 3
     ...
     $   MPI_COMPLEX, 0, MPI_COMM_WORLD, ierr)
      call MPI_Bcast(sigma1, 16*nb*nb,
     $   MPI_COMPLEX, 0, MPI_COMM_WORLD, ierr)
#endif /* USE_MPI */      

c     Determine how to stretch/compress the input sigma
c     if the lattice size for the input file
c     and the present calculation do not match.
