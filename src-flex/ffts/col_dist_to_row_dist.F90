...
subroutine col_dist_to_row_dist( myid, b, a)
  ...
  !     The following scheme allows all processor pairs to 
  !     communicate as well as performs the local copy.
  ...
  do i = 0, np - 1
     ...
     !     Fill up send buffer column after column
   ...
   return
 end subroutine col_dist_to_row_dist
