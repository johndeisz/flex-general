...
#include "../constants.F"
       ...
       if (rank .eq. 0) then
#if defined (FLEX)
         print *, 'Code compiled for the fluctuation exchange', 
     $      ' approximation.'
#elif defined (THIRD_ORDER)
         print *, 'Code compiled for third order perturbation',
     $      ' theory.'
#elif defined (SECOND_ORDER)
         print *, 'Code compiled for second order perturbation', 
     $      ' theory.'
#else
         print *, 'Code compiled for first order perturbation', 
     $      ' theory.'
#endif /* defined (FEA) */
